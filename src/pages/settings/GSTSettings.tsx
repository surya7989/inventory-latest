        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                ...
                <div>
                    ...
                    <select value={config.businessType} onChange={(e) => setConfig({ ...config, businessType: e.target.value })} className="w-full mt-2 px-4 py-3 border border-slate-200 rounded-sm outline-none">
                ...
                <div>
                    ...
                    <select value={config.defaultRate} onChange={(e) => setConfig({ ...config, defaultRate: e.target.value })} className="w-full mt-2 px-4 py-3 border border-slate-200 rounded-sm outline-none">
